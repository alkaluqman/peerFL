...
parser.add_argument("--num_clients", "-n", required=True, help="Number of Clients", type=int)
parser.add_argument("--batch_size", '-bs', default=32, help="Mini batch size of the data")
...
def batch_data(data_shard, bs=args.batch_size):
...
def create_and_save_clients(num_clients):
