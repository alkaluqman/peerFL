...
wifi2Interfaces = address.Assign(wifi2StaDevices)
...
# Assign client to left most node
echoClient = ns.applications.UdpEchoClientHelper(wifi2Interfaces.GetAddress(nWifi2 - 1), 9)
echoClient.SetAttribute("MaxPackets", ns.core.UintegerValue(1))
echoClient.SetAttribute("Interval", ns.core.TimeValue(ns.core.Seconds (1.0)))
echoClient.SetAttribute("PacketSize", ns.core.UintegerValue(1024))

clientApps = echoClient.Install(wifi1StaNodes.Get(nWifi1 - 1))
